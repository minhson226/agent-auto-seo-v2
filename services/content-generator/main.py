"""Content Generator Service - Main Application."""
...
app = FastAPI(
    ...
    description="Smart Content Generation Engine for Auto-SEO Platform",
    version="1.0.0",
...
async def readiness_check():
    ...
    return {"status": "ready", "service": "content-generator"}
