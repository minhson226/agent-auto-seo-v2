"""SEO Scorer Service - Main Application."""
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting SEO Scorer Service...")
    ...
    # Shutdown
    logger.info("Shutting down SEO Scorer Service...")
...
async def health_check():
    ...
    return {"status": "healthy", "service": "seo-scorer"}
...
async def readiness_check():
    ...
    return {"status": "ready", "service": "seo-scorer"}
